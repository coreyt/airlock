...
exec
/bin/bash -lc "sed -n '1,220p' .wake/projection.md" in /home/coreyt/projects/airlock
exec
/bin/bash -lc "sed -n '1,260p' dev/plans/0.5.1-plan.md" in /home/coreyt/projects/airlock
 succeeded in 0ms:
# Airlock 0.5.1 — Plan
...
exec
/bin/bash -lc "sed -n '1,260p' airlock/fast/router.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
"""
...
exec
/bin/bash -lc "sed -n '1,300p' airlock/fast/monitor.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
"""
...
exec
/bin/bash -c pwd in /home/coreyt/projects/airlock
 succeeded in 0ms:
/home/coreyt/projects/airlock

exec
/bin/bash -c "sed -n '55,95p' airlock/fast/router.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
        "codestral",
    ],
    "high": [
...
exec
/bin/bash -c "sed -n '330,510p' airlock/fast/router.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '510,720p' airlock/fast/router.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
    if original_model == "smart":
        if not airlock_meta:
            airlock_meta = {}
...
exec
/bin/bash -c "sed -n '1,120p' airlock/fast/state.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
"""
...
exec
/bin/bash -c "sed -n '220,310p' airlock/fast/state.py && sed -n '660,720p' airlock/fast/state.py && sed -n '1160,1385p' airlock/fast/state.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '720,900p' airlock/fast/state.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '360,370=' airlock/fast/router.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
360
361
362
...
exec
/bin/bash -c "sed -n '/_DEFAULT_PROVIDER_BUDGETS/=' airlock/fast/router.py; sed -n '/def _load_provider_budgets/=' airlock/fast/router.py; sed -n '/def _apply_budget_awareness/=' airlock/fast/router.py; sed -n '/_BUDGET_WARN_THRESHOLD/=' airlock/fast/router.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
68
369
374
...
exec
/bin/bash -c "sed -n '1,130p' airlock/fast/circuit_breaker.py; sed -n '/_DEFAULT_FAILOVER_MAP/=' airlock/fast/circuit_breaker.py; sed -n '/def _load_failover_map/=' airlock/fast/circuit_breaker.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
"""
...
exec
/bin/bash -c "sed -n '1,220p' config.yaml; sed -n '340,420p' config.yaml" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '420,480p' config.yaml; sed -n '400,465p' airlock/proxy.py; sed -n '/def set_router_config/=' airlock/fast/router.py; sed -n '285,330p' airlock/fast/router.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
    - mistral-medium
    - codestral
  high:
...
exec
/bin/bash -c "sed -n '360,405p' airlock/proxy.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '340,440p' airlock/fast/guardian.py; sed -n '/check_model_with_filters/=' airlock/fast/guardian.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '440,500p' airlock/fast/guardian.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
                        failover.failover_model,
                        failover.reason,
                    )
...
exec
/bin/bash -c "sed -n '1,240p' .venv/lib/python3.12/site-packages/litellm/caching/dual_cache.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
"""
...
exec
/bin/bash -c "sed -n '1,220p' .venv/lib/python3.12/site-packages/litellm/caching/in_memory_cache.py; sed -n '220,360p' .venv/lib/python3.12/site-packages/litellm/caching/dual_cache.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
"""
...
exec
/bin/bash -c "sed -n '/def increment_cache/,+40p' .venv/lib/python3.12/site-packages/litellm/caching/in_memory_cache.py; sed -n '/def get_cache/,+35p' .venv/lib/python3.12/site-packages/litellm/caching/in_memory_cache.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '200,260p' .venv/lib/python3.12/site-packages/litellm/router_strategy/budget_limiter.py; sed -n '360,420p' .venv/lib/python3.12/site-packages/litellm/router_strategy/budget_limiter.py; sed -n '/class BudgetConfig/,+80p' .venv/lib/python3.12/site-packages/litellm/types/utils.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '420,470p' .venv/lib/python3.12/site-packages/litellm/router_strategy/budget_limiter.py; sed -n '/def duration_in_seconds/,+80p' .venv/lib/python3.12/site-packages/litellm/litellm_core_utils/duration_parser.py; sed -n '/litellm/=' pyproject.toml; sed -n '35,55p' pyproject.toml" in /home/coreyt/projects/airlock
 succeeded in 0ms:
            value=response_cost,
            ttl=ttl,
        )
...
exec
/bin/bash -c "sed -n '1,20p' .venv/lib/python3.12/site-packages/litellm-*.dist-info/METADATA" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '480,530p' .venv/lib/python3.12/site-packages/litellm/router_strategy/budget_limiter.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '530,560p' .venv/lib/python3.12/site-packages/litellm/router_strategy/budget_limiter.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
                response_cost=response_cost,
                ttl_seconds=ttl_seconds,
            )
...
exec
/bin/bash -c "sed -n '/checkpoint_state/=' -n airlock/fast/state.py; sed -n '/checkpoint_state/=' airlock/proxy.py airlock/**/*.py; sed -n '/restore_state/=' airlock/proxy.py airlock/**/*.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
1290
307
313
...
exec
/bin/bash -c "sed -n '280,330p' airlock/proxy.py; sed -n '430,448p' airlock/proxy.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
                )
...
exec
/bin/bash -c "sed -n '1385,1465p' airlock/fast/state.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
                if fh is not None:
                    fh.close()
                current_date = today
...
exec
/bin/bash -c "sed -n '/MAX_SAMPLES/=' airlock/fast/state.py; sed -n '/class ProviderSpend/=' airlock/fast/state.py; sed -n '/spend_records/=' airlock/fast/state.py; sed -n '/def recent_spend/=' airlock/fast/state.py; sed -n '/_CB_STATE_MAX_AGE_SECONDS/=' airlock/fast/state.py; sed -n '/def checkpoint_state/=' airlock/fast/state.py; sed -n '/def restore_state/=' airlock/fast/state.py; sed -n '/def ingest_jsonl_record/=' airlock/fast/state.py; sed -n '/def tail_jsonl/=' airlock/fast/state.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
24
172
173
...
exec
/bin/bash -c "ls tests | sed -n '1,80p'" in /home/coreyt/projects/airlock
 succeeded in 0ms:
__init__.py
__pycache__
conftest.py
...
exec
/bin/bash -c "sed -n '1,260p' tests/test_fast_router.py; sed -n '1,260p' tests/test_fast_circuit_breaker.py; sed -n '1,260p' tests/test_fast_monitor.py; sed -n '1,260p' tests/test_fast_state.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '260,560p' tests/test_fast_state.py; sed -n '/ProviderSpend/=' tests/test_fast_state.py; sed -n '/checkpoint/=' tests/test_fast_state.py; sed -n '/restore/=' tests/test_fast_state.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
...
exec
/bin/bash -c "sed -n '560,690p' tests/test_fast_state.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
            admitted.append(result)
...
exec
/bin/bash -c "sed -n '/def increment_cache/,+45p' .venv/lib/python3.12/site-packages/litellm/caching/redis_cache.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
    def increment_cache(
...
exec
/bin/bash -c "sed -n '/async def async_increment/,+55p' .venv/lib/python3.12/site-packages/litellm/caching/redis_cache.py" in /home/coreyt/projects/airlock
 succeeded in 0ms:
