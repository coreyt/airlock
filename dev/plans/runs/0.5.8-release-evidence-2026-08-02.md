...
1. Release commit `2bf044f` was pushed to `main`.
2. GitHub issue #22 was closed with this audit evidence.
3. CI run [`30755606843`](https://github.com/coreyt/airlock/actions/runs/30755606843)
   passed all four jobs: test, lint, Docker, and security.
4. Annotated tag `v0.5.8` was pushed. Release run
   [`30755862399`](https://github.com/coreyt/airlock/actions/runs/30755862399) passed
   its version check, full tests, build, PyPI trusted publishing, and GitHub-release
   job. The published release is
   [`v0.5.8`](https://github.com/coreyt/airlock/releases/tag/v0.5.8).
