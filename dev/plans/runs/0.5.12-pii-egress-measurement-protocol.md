...
```bash
PYTHONPATH=python .venv/bin/python scripts/measurement-report.py pii-egress logs/ \
  --start 2026-08-10T00:00:00+00:00 --end 2026-08-17T00:00:00+00:00
```

The report intentionally ends in `human_decision_required: true`; it is not an
